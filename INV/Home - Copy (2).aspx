...
<html class="no-js" style=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="materialize-src/sass/estilosMaterialize.css?0.0.0.1">
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                var contextMenu = $("#jqxMenu").jqxMenu({ width: '140px', height: '30px', autoOpenPopup: false, mode: 'popup', theme: theme });
                $("body").on("mousedown", "#_jqxgrid", function() {
                    if (articulounico) {
                        var rightClick = isRightClick(event);
                        if (rightClick && codselect != '') {
    ...
    <body id="idBody" >
	    ...
	    <div class="notification">
		    <div id="topMsj">
			    <span>EXISTEN PRODUCTOS CON STOCK BAJO 
				    <a href="#modalGrip" id="listaarticulosc" style="color:Yellow;"> (Ver lista de Productos)</a>
			    </span>
		    </div>
		    <div id="bottomMsj">
			    <span>EXISTEN PRODUCTOS POR INGRESAR 
				    <a href="#modalGrip" id="listaarticulosu" style="color:Yellow;"> (Ver lista de Productos)</a>
                     <!-- class="modal-trigger" -->
			    </span>
		    </div>
	    </div>
        ...
        <div class="cont_grid" style="width:1250px;" id="modalCalendarContent">
            ...
            <div id="_jqxgrid"></div>
            <iframe src='Tablas/Articulo.aspx' id='iframe1' width='100%' height='100%' frameborder='0' scrolling='no'></iframe>
    ...
    <script type="text/javascript">
        ...
        function ShowArticulo() {
            ...
            $(".desktop").html("<div id='iframes'><iframe src='Tablas/Articulo.aspx' id='iframe' width='100%' height='" + alto_iframe + "' frameborder='0' scrolling='no'></iframe></div>");
        ...
        $(document).ready(function () {
            ...
            // click en algun boton llama iframe
             $(".dropdown").find("a").click(function () {
                  ...
                  $(".desktop").html("<div id='iframes'><iframe src='"+vinculo+"' id='iframe' width='100%' height='"+alto_iframe+"' frameborder='0' scrolling='no'></iframe></div>");
                  $(".sidebar").animate({
                          left: "-230px",
                        }, 500 );
                  return false;
                ...
                $("#_loadGridView").click(function() {
                    ...
                    {   
                        ...
                        columns: [
                          ...
                          { text: 'Exis', columntype: 'textbox', filtertype: 'textbox', datafield: 'exist', width: 50 },
