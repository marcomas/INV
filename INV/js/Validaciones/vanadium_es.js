    ...
    Vanadium
			.addValidatorTypes([
					...
					[
							...
							"required", function(a) {
							    blok = !Vanadium.validators_types.empty.test(a);
							    return blok;
					...
					[
							...
							"Por favor, introduzca un n&uacute;mero entero válido en este campo."],
					[
							"number",
							function(a) {
					...
					[
							...
							"Por favor, use solo numeros en este campo. Evite espacios u otros caracteres, tales como puntos o comas."],
					[
							"codemp",
							function(a) {
							    return Vanadium.validators_types.empty.test(a)
							...
							"Por favor, introduzca el codigo, por ej:emp-, Evite espacios u otros caracteres, tales como puntos o comas."],

					[
							"tlfl",
							function(a) {
							    blok = Vanadium.validators_types.empty.test(a)
										|| (/[^6-9]\-[\d]+$/.test(a) && a.length != 8);
							    ///\w{1,}[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/
							    
							    return blok;

							},
							"Por favor, introduzca un n&uacute;mero de tel&eacute;fono local, por ej:0251-2215522, Evite espacios u otros caracteres."],
					...
					[
							...
							"Por favor, introduzca un n&uacute;mero de tel&eacute;fono  m&oacute;vil, por ej: 0416-2226667, Evite espacios u otros caracteres."],
					...
					[
							...
							"Por favor, use s&oacute;lo letras (a-z) (A-Z) en este campo."],
				    [
							"espacB",
							function(a) {
							    return Vanadium.validators_types.empty.test(a)
							...
							"Por favor, deje espacio en blanco en este campo."],
					...
					[
							...
							"Por favor, use s&oacute;lo letras (a-z) y n&uacute;meros (0-9) en este campo. Sin espacios u otros caracteres."],
					[
							"date",
							function(a) {
							    var b = new Date(a);
					...
					[
							"email",
							function(a) {
							    blok = (Vanadium.validators_types.empty.test(a) || /\w{1,}[@][\w\-]{1,}([.]([\w\-]{1,})){1,3}$/
										.test(a));
								return blok;
							},
							"Por favor, introduzca una direcci&oacute;n de correo electr&oacute;nico v&aacute;lida. Por ejemplo: xxx@domain.com ."],
					...
					[
							...
							"Por favor, use este formato de fecha: dd/mm/aaaa. Por ejem. 01/02/1982."],
					[
							"fechaValida",
							function(a) {
							    if (Vanadium.validators_types.empty.test(a)) {
					...
					[
							...
							"Por favor, introduzca un importe de $ v&aacute;lida. Por ejemplo, $ 100,00."],
					[
							"selection",
							function(a, b) {
