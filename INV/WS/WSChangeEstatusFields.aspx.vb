...
Partial Public Class WSChangeEstatusFields
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Select Case fun
            Case "cambiaEstatus"
                dataList = DataHelper.CambiaEstatus(tabla, id)
                WriteResult(dataList, result)
            Case "cambiaConsumible"
                dataList = DataHelper.CambiaConsumible(tabla, id)
                WriteResult(dataList, result)
            Case "cambiaEstatusArticulo"
                dataList = DataHelper.CambiaEstatusArticulo(id, data)
                WriteResult(dataList, result)
            Case "resetPswUsuario"
                dataList = DataHelper.ResetPswUsuario(id)
                WriteResult(dataList, result)
        End Select
