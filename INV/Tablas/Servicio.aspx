<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Servicio.aspx.vb" Inherits="INV.Servicio" %>
...
<head runat="server">
    ...
    <script>
        ...
        $(function() {
            tablaToolBar = tabla;
            columnsExports = 'codigo|nombre|cedula|resp|tlf|email|estatus';
            columnsExportCaption = 'Codigo|Nombre|Cedula/Rif|Responsable|Telefonos|Email|Estatus';
            numreport = 4;
    ...
    <script>
            ...
            $("#loadGridView").click(function() {
                ...
                $("#jqxgrid").jqxGrid(
                {
                    ...
                    columns: [
                          ...
                          { text: 'Nombre', columntype: 'textbox', filtertype: 'textbox', datafield: 'nombre', width: 220 },
                          { text: 'Cedula/Rif', columntype: 'textbox', filtertype: 'textbox', datafield: 'cedula', width: 100 },
                          { text: 'Responsable', columntype: 'textbox', filtertype: 'textbox', datafield: 'resp', width: 200 },
                          { text: 'Teléfonos', columntype: 'textbox', filtertype: 'textbox', datafield: 'tlf', width: 250 },
                          { text: 'Email', columntype: 'textbox', filtertype: 'textbox', datafield: 'email', width: 250 },
        ...
        function LoadGridView(index) {
            ...
            column5.push(aSource[index].split('|')[6] + ' / ' + aSource[index].split('|')[7]);
            column6.push(aSource[index].split('|')[9]);

            var valEstatus = aSource[index].split('|')[12];
            if (valEstatus == 0) { column7.push('Inactivo'); } else { column7.push('Activo'); }            
        } 
...
<body class="body_iframe">
    ...
    <h1 class="titulo_iframe">Servicios<a href="#" id="btn_cerrar"></a></h1>
    <!-- fin titulo -->
    ...
    <div class="cont_grid" style="width:1100px;" id="divLista">
    ...
    <div class="seccion" style="position:relative; top:0px;">
        ...
        <div class="table table_foto" style="float:left;">
            ...
            <div class="row">
                ...
                <div class="cell"><input type="text" id="txtEmail" class=":email" style="width:300px;"/></div>
            </div> 
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="cell"><input type="text" id="txtDireccion" style="width:140px;"/></div>
            </div>
            <div class="row">
                <div class="cell"><Label>NOTAS</label></div>
                <div class="cell"><input type="text" id="txtNotas" style="width:140px;"/></div>
            </div>
            <div class="row">
