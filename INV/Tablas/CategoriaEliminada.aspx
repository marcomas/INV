<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CategoriaEliminada.aspx.vb" Inherits="INV.CategoriaEliminada" %>
...
<head runat="server">
	...
	<script src="../js/toolbarOnlySee.js?0.0.0.2"></script>
    ...
    <script>
        ...
        function RecuperarRecordEliminado(nombre, idRecordRecuperar) {

            $.msgBox({
                title: "Alerta",
                content: "Desea Restaurar la categoria " + nombre + " y todos los Articulos registrados en ella?",
                type: "confirm",
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#jqxgrid").on('rowselect', function(event) {
                ...
                nombre = event.args.row.nombre;
                idRecordRecuperar = event.args.row.id;
                RecuperarRecordEliminado(nombre, idRecordRecuperar);
                if (index > -1) { GetValue(index); }
        ...
        function LoadGridView(index) {
            ...
            column4.push(aSource[index].split('|')[0]);
        } 
...
<body class="body_iframe">
    ...
    <div class="cont_grid" style="width:1000px;" id="divLista">
        <button id="btExportToExcel" title="exportar a excel" style="left:15px; height:30px;position:relative;margin-left:10px;margin-right:15px;margin-top:5px;" class="btn_new"><img src="../images/icon_excel.png"/></button>
