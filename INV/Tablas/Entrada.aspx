<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Entrada.aspx.vb" Inherits="INV.Entrada" %>
...
<head runat="server">
    ...
    <script>
        ...
        //-- CONSTANTES --//
        var tabla = 'entrada';
        var columnsExports = 'articulo|nivel|cantidad|responsable|fechareg|estatus';
        var columnsExportCaption = 'Articulo|Nivel|Cantidad|Responsable|Fecha Registro|Estatus';
        var numreport = 7;
...
<body class="body_iframe">
    ...
    <h1 class="titulo_iframe">Entradas<a href="#" id="btn_cerrar"></a></h1>
    <!-- fin titulo -->
    ...
    <div class="cont_grid" style="width: 1200px; border: none; left: 4%; top: 20%; z-index:997;" id="divLista">
        <h1 class="title_grid"></h1>
        <!--#include file="../inc/grid_Entrada.html"-->
    </div>
